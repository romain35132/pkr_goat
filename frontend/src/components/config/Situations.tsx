  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900">Gestion des Situations</h2>
        <button
      ...
      {isEditing && (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Parent ID (Optionnel)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Runout ID (Optionnel)</label>
              <input
                type="number"
            ...
            <div className="col-span-1 md:col-span-2">
              <label className="block text-sm font-medium text-gray-700">Historique des actions</label>
              <input
                type="text"
                required
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {situations.map(situation => (
              <tr key={situation.id}>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{situation.id}</td>
                ...
                <td className="px-6 py-4 text-sm text-gray-500">{situation.action_history}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{situation.parent_id || '-'}</td>
